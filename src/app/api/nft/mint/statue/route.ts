...
export async function POST() {
  try {
    ...
    // Upload image data
    const imageFile = fs.readFileSync(path.join(process.cwd(), 'public/images/nft/statue.png'));
    ...
    const metadata = {
      name: "Q Drop Adventure Statue NFT",
      description: "This is a Q Drop Adventure Statue NFT",
      image: irysImageUri,
